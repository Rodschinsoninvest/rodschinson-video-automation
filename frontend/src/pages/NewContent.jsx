...
const TEMPLATE_GROUPS = {
  video: [
    ...
    },
    {
      ...
      scenes: ['Title Card', 'Bullet Points', 'Split Screen', 'Process Steps', 'CTA'],
    },
    {
  ...
  reel: [
    { id: 'reel_premium',  label: 'Premium',  gradient: 'linear-gradient(135deg,#08316F,#041d45)', accent: '#C8A96E', desc: 'Dark blue · gold · institutional',   scenes: ['Title Card', 'Big Number', 'Bullet Points', 'Bar Chart', 'CTA'] },
    { id: 'reel_data',     label: 'Data',     gradient: 'linear-gradient(135deg,#080E1A,#0d1a30)', accent: '#00E5C8', desc: 'Dark · cyan · data terminal',        scenes: ['Title Card', 'Big Number', 'Bar Chart', 'Bullet Points', 'CTA'] },
    { id: 'reel_bold',     label: 'Bold',     gradient: 'linear-gradient(135deg,#0a0a0a,#1a0505)', accent: '#FF4444', desc: 'Black · red · high-energy',           scenes: ['Title Card', 'Big Number', 'Bullet Points', 'Bar Chart', 'CTA'] },
    { id: 'reel_minimal',  label: 'Minimal',  gradient: 'linear-gradient(135deg,#F5F5F0,#e8e8e0)', accent: '#08316F', desc: 'White · editorial · clean',           scenes: ['Title Card', 'Big Number', 'Bullet Points', 'Bar Chart', 'CTA'] },
    { id: 'reel_gradient', label: 'Gradient', gradient: 'linear-gradient(135deg,#1a0a2e,#2d1454,#08316F)', accent: '#a855f7', desc: 'Purple · gold · modern',      scenes: ['Title Card', 'Big Number', 'Bullet Points', 'Bar Chart', 'CTA'] },
  ],
  story: [
    { id: 'reel_premium',  label: 'Premium',  gradient: 'linear-gradient(135deg,#08316F,#041d45)', accent: '#C8A96E', desc: 'Dark blue · gold · branded',          scenes: ['Title Card', 'Big Number', 'Bullet Points', 'Bar Chart', 'CTA'] },
    { id: 'reel_data',     label: 'Data',     gradient: 'linear-gradient(135deg,#080E1A,#0d1a30)', accent: '#00E5C8', desc: 'One stat · full screen · cyan',        scenes: ['Title Card', 'Big Number', 'Bar Chart', 'Bullet Points', 'CTA'] },
    { id: 'reel_bold',     label: 'Bold',     gradient: 'linear-gradient(135deg,#0a0a0a,#1a0505)', accent: '#FF4444', desc: 'Black · red · flash impact',           scenes: ['Title Card', 'Big Number', 'Bullet Points', 'Bar Chart', 'CTA'] },
    { id: 'reel_minimal',  label: 'Minimal',  gradient: 'linear-gradient(135deg,#F5F5F0,#e8e8e0)', accent: '#08316F', desc: 'White · clean · editorial',            scenes: ['Title Card', 'Big Number', 'Bullet Points', 'Bar Chart', 'CTA'] },
...
const INITIAL_FORM = {
  ...
  template: 'educational', style: 'viral_hook',
